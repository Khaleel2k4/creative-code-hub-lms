...
const sectionConfig = {
  ...
  mentors: {
    ...
    tabs: {
      ...
      // 'Assign Courses' removed per request
    }
  },
  students: {
    ...
    tabs: {
      ...
      // 'Enrollment Stats' removed per request
    }
  },
  courses: {
  ...
  assessments: {
    ...
    tabs: {
      ...
      // Question Bank and Grading System removed per request
    }
  },
  announcements: {
    ...
    tabs: {
      ...
      // Templates, Scheduled Posts, Analytics removed per request
    }
  }
};
  ...
  assessments: {
    ...
    items: [
      ...
      { section: 'assessments', tab: 'results', label: 'Assessment Results' },
        // Question Bank and Grading System removed
    ]
  },
  announcements: {
    icon: Megaphone,
    ...
    items: [
      ...
      { section: 'announcements', tab: 'create', label: 'Create Announcement' },
        // Templates, Scheduled Posts, Analytics removed
    ]
  }
};
        ...
        <div className="table-header">
          <div className="search-section">
            <div className="search-box">
              ...
              <input
                type="text"
                placeholder={`Search ${sectionConfig[activeSection]?.title.toLowerCase()}...`}
          ...
          <div className="pagination-container">
            ...
            <div className="pagination-controls">
              ...
              {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
                <button
                  key={page}
                  className={`btn pagination-btn ${currentPage === page ? 'btn-primary' : 'btn-outline'}`}
